...
X = np.load("./test_model/data/X_train_norm_augm.npy")
y = np.load("./test_model/data/y_train_norm_augm.npy")
...
print(f"num in trian: {len(train_dataset)}")
...
# 修正val_loader
X = np.load("./test_model/data/X_val_norm_augm.npy")
y = np.load("./test_model/data/y_val_norm_augm.npy")
device = torch.device("mps")
...
print(f"num in val: {len(val_dataset)}")
...
writer = SummaryWriter("./train4eu/runs/norm_200ep_augm")
